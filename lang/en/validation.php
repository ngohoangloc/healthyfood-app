...
return [
    ...
    */
    ...
    'required_if' => ':Attribute là trường bắt buộc.',
    ...
    'size' => [
        'numeric' => ':Attribute phải có :size số.',
    ...
    */
    ...
    'attributes' => [
        ...
        'desc' => 'mô tả chi tiết',
        'symbol' => 'ký hiệu',
        'minInventoryLevel' =>'giá trị tồn kho tối thiểu',
        'maxInventoryLevel' =>'giá trị tồn kho tối đa',
        'type' =>'loại hàng hóa',
        'category_id' =>'nhóm hàng hóa',
        'unit_id' =>'đơn vị tính',
        'item_price' =>'giá bán',
        'address' => 'địa chỉ',
        'role_id'=> 'vị trí',
